...
$p1 = run($x, $y, $dir, $grid, $chars, $movements, $dirs, "moveP1");
$p2 = run($x, $y, $dir, $grid, $chars, $movements, $dirs, "moveP2");

echo "P1: $p1\nP2: $p2\n";

function run($x, $y, $dir, $grid, $chars, $movements, $dirs, $edgeFunc) {
    $count = "";
            ...
            if (!isset($chars[$charPos+1]) || !is_numeric($chars[$charPos+1])) {
                ...
                for ($i = 0; $i < $count; $i++) {
                    ...
                    if (!isset($grid[$newY][$newX])) {
                        list($newY, $newX, $newDir) = $edgeFunc($grid, $y, $x, $dirs[$dir]);
                    }
